                ...
                if (ResponseFound) {
                  ...
                  while (!EEPROM_BurnDone) {
                    if (RTX_PROTOCAL.Connected()) {
                      ...
                      //              noInterrupts();
                      Serial.flush();
                      bool WriteStat = RTX_PROTOCAL.Write(SlaveIP_Selected, RTX_REQ_EEPROM_BURN_STAT_LEN, RTX_TX);
                      //              interrupts();
                      if (WriteStat) {
                        uint32_t RTX_ReadTimeOut = micros();
                        ResponseFound = false;
            ...
            if (Add > -1 && Add < 256) {
              if (ParseNext() == 0) {
                ...
                if (ParseCharSingle() == ' ') {
                  ...
                  if (Val > -1 && Val < 256) {
                    if (ParseNext() == 0) {
                      Serial.print(F("CONFIG-BUFFER WRITE (ADD: ") P Add P F(", VAL: ") ); PrintBoolHexDec(Val P_ F(")"));
                      Serial.println();
                      Serial.print(F("WRITING CONFIG-BUFFER (ADD: ") P Add P F(", VAL: ") ); PrintBoolHexDec(Val P F(") IP: ") P_ SlaveIP_Selected);
                      if (RTX_PROTOCAL.Connected()) {
                        ...
                        if (WriteStat) {
                          ...
                          if (ResponseFound) {
                            ...
                            if (BufferWriteError) {
                              ...
                              Serial.print(F("WRITE: (ADD: ") P BufferWrite[0] P F(", VAL: ") ); PrintBoolHexDec(BufferWrite[1] P_ F(")"));
                            }
                            Serial.println();
                            Serial.println();
                            delay(500);
            ...
            if (Add > -1 && Add < 256) {
              if (ParseNext() == 0) {
                ...
                if (ParseCharSingle() == ' ') {
                  ...
                  if (Val > -1 && Val < 256) {
                    if (ParseNext() == 0) {
                      Serial.print(F("DEBUG-BUFFER WRITE (ADD: ") P Add P F(", VAL: ") ); PrintBoolHexDec(Val P_ F(")"));
                      Serial.println();
                      Serial.print(F("WRITING DEBUG-BUFFER (ADD: ") P Add P F(", VAL: ") ); PrintBoolHexDec(Val P F(") IP: ") P_ SlaveIP_Selected);
                      if (RTX_PROTOCAL.Connected()) {
