...
//        _PacketCount = true;
        ...
        _PacketID = word(_Buffer[10], _Buffer[11]);
        Serial.print("PacketID: ");
        Serial.println(_PacketID);
...
void ATEM_UIP::SendCommand(char *CMD, uint8_t *CMD_Packet, uint8_t CMD_Bytes) {
  ...
  if (CMD_Bytes <= 16 && _PacketID == _LastRemotePacketID) {
